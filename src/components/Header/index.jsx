...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/Theme/select';
...
function Header({
	...
	return (
		<div className="flex flex-col items-start justify-between space-y-2 lg:flex-row lg:items-center">
			<div>
